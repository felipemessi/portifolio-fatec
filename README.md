...
No projeto do Semaforo do consumidor, eu tive um papel mais de "business", onde eu olhei muito mais para as possibilidades do negócio, junto ao P.O., analisando os requisitos e tentando trazer o máximo de valor para o cliente. Foi particularmente desafiador, pois esbarramos inúmeras vezes com a Lei geral de proteção de Dados (LGPD). Para driblar essas dificuldades, foi necessário bastante pesquisa e discussões junto ao time.
...
Este projeto foi a virada de chave, eu consegui encabeçar o recrutamento de um time super legal, de pessoas interessadas e com um conhecimento técnico que se complementava. Durante este projeto eu colaborei principalmente exercendo o papel de Scrum Master, estando sempre atento aos problemas da equipe e tentando solucionar o mais rápido possíve. Me planejei antecipadamente para produzir uma documentação clara e completa alem de, trazer conhecimento externo para equipe para que pudéssemos nos desenvolver e entregar um produto com mais valor.
